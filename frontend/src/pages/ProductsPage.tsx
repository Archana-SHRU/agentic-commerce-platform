...
export const ProductsPage: React.FC = () => {
  ...
  // Apply filters carried over from the AI assistant / home search bar
  // (e.g. "show me phones under 30000" -> category=Mobile, maxPrice=30000)
  useEffect(() => {
    const state = location.state as ProductsPageNavState | null
    if (!state?.query) return

    const derived = deriveProductsPageFilters(state.query)
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result
  }, [search, selectedCategory, priceRange, sortBy, catalogProducts])
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-3">
              Discover products
              <span className="text-cyan-300"> you'll love.</span>
            </h1>
            ...
            <div className="bg-white rounded-2xl p-2 shadow-2xl flex items-center gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  placeholder="Search laptops, headphones, watches, fashion..."
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {[
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-full bg-white/15 hover:bg-white/25 border border-white/20 text-sm transition"
                >
                  {item}
                </button>
              ))}
